...
public class Employee implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "absences", "jobs", "manager", "department" }, allowSetters = true)
    ...
    public void setAbsences(Set<Absence> absences) {
        if (this.absences != null) {
            this.absences.forEach(i -> i.setEmployee(null));
        }
        if (absences != null) {
            absences.forEach(i -> i.setEmployee(this));
        }
        this.absences = absences;
    }

    public Employee absences(Set<Absence> absences) {
        this.setAbsences(absences);
        return this;
    }

    public Employee addAbsence(Absence absence) {
        this.absences.add(absence);
        absence.setEmployee(this);
        return this;
    }

    public Employee removeAbsence(Absence absence) {
