...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './auhority.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUHORITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUHORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUHORITY actions', async () => {
      const expectedActions = [
        {
