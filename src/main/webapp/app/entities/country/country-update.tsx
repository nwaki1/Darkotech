  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="darkotechApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="darkotechApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('darkotechApp.country.countryName')}
              ...
              <ValidatedField
                ...
                name="region"
                data-cy="region"
                label={translate('darkotechApp.country.region')}
                type="select"
              >
                <option value="" key="0" />
                {regions
