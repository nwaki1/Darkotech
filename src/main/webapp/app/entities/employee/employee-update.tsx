  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="darkotechApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="darkotechApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('darkotechApp.employee.firstName')}
              ...
              <ValidatedField
                label={translate('darkotechApp.employee.lastName')}
              ...
              />
              <ValidatedField
                label={translate('darkotechApp.employee.email')}
                id="employee-email"
                name="email"
                data-cy="email"
                type="text"
              />
              <ValidatedField
                label={translate('darkotechApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('darkotechApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('darkotechApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('darkotechApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('darkotechApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('darkotechApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
