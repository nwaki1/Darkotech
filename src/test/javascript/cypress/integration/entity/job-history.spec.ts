...
describe('JobHistory e2e test', () => {
  ...
  describe('new JobHistory page', () => {
    ...
    it('should create an instance of JobHistory', () => {
      cy.get(`[data-cy="startDate"]`).type('2021-12-10T03:09').should('have.value', '2021-12-10T03:09');

      cy.get(`[data-cy="endDate"]`).type('2021-12-09T17:18').should('have.value', '2021-12-09T17:18');
